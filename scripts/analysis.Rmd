...
climate_data_sens <- readRDS("../data/dataset_14d_5to9.rds")
...
var_covariates_2 <- c("scale(interview_age)", "scale(interview_age)^2", "scale(interview_age)^3", "sex_br", "race_black", "race_white", "ethnicity_hisp", "scale(household_income)")
...
var_covariates_7 <- c(var_covariates_2, "scale(reshist_addr1_d1a)", "scale(reshist_addr1_walkindex)", "scale(reshist_addr1_popdensity)")
```

# Analysis
## Main analysis: combined past/current externalizing symptoms
```{r}
...
mod_ksads_1 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                           variables = var_headache_0, var_added = var_covariates_0), data = climate_data, 
                    control=lmerControl(check.nobs.vs.nlev = "ignore",
                                        check.nobs.vs.rankZ = "ignore",
                                        check.nobs.vs.nRE="ignore",
                                        optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
mod_ksads_3 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
...
mod_ksads_4 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                           variables = var_headache_0, var_added = var_covariates_3), data = climate_data, 
                    control=lmerControl(check.nobs.vs.nlev = "ignore",
                                        check.nobs.vs.rankZ = "ignore",
                                        check.nobs.vs.nRE="ignore",
                                        optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))

mod_ksads_5 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                           variables = var_headache_0, var_added = var_covariates_4), data = climate_data, 
                    control=lmerControl(check.nobs.vs.nlev = "ignore",
                                        check.nobs.vs.rankZ = "ignore",
                                        check.nobs.vs.nRE="ignore",
                                        optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))

mod_ksads_6 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                           variables = var_headache_0, var_added = var_covariates_5), data = climate_data, 
                    control=lmerControl(check.nobs.vs.nlev = "ignore",
                                        check.nobs.vs.rankZ = "ignore",
                                        check.nobs.vs.nRE="ignore",
                                        optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))

mod_ksads_7 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                           variables = var_headache_0, var_added = var_covariates_6), data = climate_data, 
                    control=lmerControl(check.nobs.vs.nlev = "ignore",
                                        check.nobs.vs.rankZ = "ignore",
                                        check.nobs.vs.nRE="ignore",
                                        optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))

mod_ksads_8 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                           variables = var_headache_0, var_added = var_covariates_7), data = climate_data, 
                    control=lmerControl(check.nobs.vs.nlev = "ignore",
                                        check.nobs.vs.rankZ = "ignore",
                                        check.nobs.vs.nRE="ignore",
                                        optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
# Table 2
tab_model(mod_ksads_0, mod_ksads_1, mod_ksads_2, mod_ksads_3)
# Table S3
tab_model(mod_ksads_4, mod_ksads_5, mod_ksads_6, mod_ksads_7, mod_ksads_8)
```
...
mod_beforeCovid_ksads_1 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                                       variables = var_headache_0, var_added = var_covariates_0), data = climate_data_beforeCovid, 
                                control=lmerControl(check.nobs.vs.nlev = "ignore",
                                                    check.nobs.vs.rankZ = "ignore",
                                                    check.nobs.vs.nRE="ignore",
                                                    optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
mod_beforeCovid_ksads_3 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
...
# Table S4
tab_model(mod_beforeCovid_ksads_0, mod_beforeCovid_ksads_1, mod_beforeCovid_ksads_2, mod_beforeCovid_ksads_3)
```
...
mod_MaySep_ksads_1 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                                  variables = var_headache_0, var_added = var_covariates_0), data = climate_data_sens, 
                           control=lmerControl(check.nobs.vs.nlev = "ignore",
                                               check.nobs.vs.rankZ = "ignore",
                                               check.nobs.vs.nRE="ignore",
                                               optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
mod_MaySep_ksads_3 <- lmer(models(outcome = "scale(ksads_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
...
# Table S5
tab_model(mod_MaySep_ksads_0, mod_MaySep_ksads_1, mod_MaySep_ksads_2, mod_MaySep_ksads_3)
```
...
mod_ksads_current_3 <- lmer(models(outcome = "scale(ksads_present_externalizing_exclude_attentation_symptoms_sum)", predictor = "scale(dx90)", 
                                   variables = var_headache_0, var_added = var_covariates_2), data = climate_data, 
                            control=lmerControl(check.nobs.vs.nlev = "ignore",
                                                check.nobs.vs.rankZ = "ignore",
                                                check.nobs.vs.nRE="ignore",
...
# Table S6
tab_model(mod_ksads_current_0, mod_ksads_current_1, mod_ksads_current_2, mod_ksads_current_3)
```
...
mod_SA_current_1 <- glmer(models(outcome = "SA_current_y", predictor = "scale(dx90)", variables = var_headache_0, var_added = var_covariates_0),
                          data = climate_data, family = binomial, nAGQ = 0)

mod_SA_current_2 <- glmer(models(outcome = "SA_current_y", predictor = "scale(dx90)", variables = var_headache_0, var_added = var_covariates_1),
                          data = climate_data, family = binomial, nAGQ = 0)

mod_SA_current_3 <- glmer(models(outcome = "SA_current_y", predictor = "scale(dx90)", variables = var_headache_0, var_added = var_covariates_2),
                          data = climate_data, family = binomial, nAGQ = 0)

# Table S7
tab_model(mod_SA_current_0, mod_SA_current_1, mod_SA_current_2, mod_SA_current_3)
```

## Sensitivity analysis: outcome SA_y
```{r}
mod_SA_0 <- glmer(models(outcome = "SA_y", predictor = "scale(dx90)", variables = var_headache_0, var_added = NULL), 
                  data = climate_data, family = binomial, nAGQ = 0)

mod_SA_1 <- glmer(models(outcome = "SA_y", predictor = "scale(dx90)", variables = var_headache_0, var_added = var_covariates_0), 
                  data = climate_data, family = binomial, nAGQ = 0)

mod_SA_2 <- glmer(models(outcome = "SA_y", predictor = "scale(dx90)", variables = var_headache_0, var_added = var_covariates_1), 
                  data = climate_data, family = binomial, nAGQ = 0)

mod_SA_3 <- glmer(models(outcome = "SA_y", predictor = "scale(dx90)", variables = var_headache_0, var_added = var_covariates_2), 
                  data = climate_data, family = binomial, nAGQ = 0)

# Table S8
tab_model(mod_SA_0, mod_SA_1, mod_SA_2, mod_SA_3)
```
