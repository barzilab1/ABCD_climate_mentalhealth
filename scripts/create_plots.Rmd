...
# latlon <- read.csv("../materials/ABCD_21sites_all_stations_closet_020123_withlatlon.csv")
```

```{r}
# create the data for map labels (dx90 mean & sd)
dx90_meansd <- read.csv("../outputs/tableS3_020223.csv")
dx90_meansd %>% 
  ...
  filter(station == "USW00093134") %>% 
  pull(mean_sd)

dx90_meansd$station[!dx90_meansd$station %in% c("USC00085667", "USW00053908", "USC00356749", "USC00046646", "USC00049152", "USW00093784", "USC00421446", "USC00475474", "USC00237452")] #"USC00200230" "USC00214884" "USC00360861" "USW00000160" "USW00012816" "USW00013740" "USW00013782" "USW00014742" "USW00014758" "USW00014768" "USW00093107"
# [12] "USW00093134"
```
