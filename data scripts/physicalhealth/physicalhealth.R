...
write.csv(file = "data/physicalhealth_1year.csv",x = physicalhealth_1year, row.names = F, na = "")

physicalhealth_baseline = merge(mx01,yrb)
write.csv(file = "data/physicalhealth_baseline.csv",x = physicalhealth_baseline, row.names = F, na = "")
